...
- **Backend API**: https://notapp-mrvineetraj.onrender.com/
...
```env
BACKEND_URL="https://notapp-mrvineetraj.onrender.com/"
```
...
const response = await fetch('https://notapp-mrvineetraj.onrender.com/api/notes', {
  method: 'POST',
  headers: { 'Content-Type': 'application/json' },
  body: JSON.stringify({ text: 'My new note' })
});
